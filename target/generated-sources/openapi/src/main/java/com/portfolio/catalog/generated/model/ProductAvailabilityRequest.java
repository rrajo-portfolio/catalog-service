...
public class ProductAvailabilityRequest {
   ...
   */
  public ProductAvailabilityRequest(StatusEnum status) {
    this.status = status;
  }

  public ProductAvailabilityRequest status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, productAvailabilityRequest.status);
  }
